    ...
    public class KhadiStoreDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product { Id = 1, Name = "White Khadi Kurta", Description = "Pure white khadi cotton kurta for men", CategoryId = 3, Price = 1500, StockQuantity = 50, MinStockLevel = 10, SKU = "KH001", FabricType = "Khadi Cotton", Color = "White", Size = "L", Pattern = "Solid", GST = 0.0m, IsActive = true, Origin = "Gujarat", CreatedAt = DateTime.UtcNow, CreatedBy = "System" },
                new Product { Id = 2, Name = "Red Silk Saree", Description = "Traditional red silk saree with gold border", CategoryId = 2, Price = 8500, StockQuantity = 25, MinStockLevel = 5, SKU = "SL001", FabricType = "Silk", Color = "Red", Pattern = "Border", GST = 0.0m, IsActive = true, Origin = "Karnataka", CreatedAt = DateTime.UtcNow, CreatedBy = "System" },
                new Product { Id = 3, Name = "Blue Cotton Kurti", Description = "Casual blue cotton kurti with prints", CategoryId = 4, Price = 850, StockQuantity = 75, MinStockLevel = 15, SKU = "CT001", FabricType = "Cotton", Color = "Blue", Size = "M", Pattern = "Printed", GST = 0.0m, IsActive = true, Origin = "Rajasthan", CreatedAt = DateTime.UtcNow, CreatedBy = "System" },
                ...
                new Product { Id = 5, Name = "Green Khadi Dupatta", Description = "Light green khadi dupatta with tassels", CategoryId = 1, Price = 650, StockQuantity = 40, MinStockLevel = 10, SKU = "KH002", FabricType = "Khadi Cotton", Color = "Green", Pattern = "Plain", GST = 0.0m, IsActive = true, Origin = "West Bengal", CreatedAt = DateTime.UtcNow, CreatedBy = "System" }
            );
